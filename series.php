...
<div class="list--Tabsui">
    <a onClick="setNewquery('order' , 'year')" class="hoverable active"><i class="far fa-clock"></i> مسلسلات جديدة </a>
    <a onClick="setNewquery('order' , 'ryear')"  class="hoverable "><i class="far fa-folder-open"></i>  مسلسلات قديمة</a>
    <a onClick="setNewquery('order' , 'top')"  class="hoverable "><i class="fas fa-fire"></i> الاكثر مشاهدة</a>
    <a onClick="setNewquery('order' , 'last')"  class="hoverable "><i class="fas fa-laptop"></i> آخر المسلسلات</a>
    <a onClick="setNewquery('order' , 'episodes')"  class="hoverable "><i class="fas fa-list-alt"></i> آخر الحلقات </a>
</div>
